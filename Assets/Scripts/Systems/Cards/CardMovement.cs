...
{
    public class CardMovement : MonoBehaviour, IDragHandler, IPointerDownHandler, IPointerEnterHandler,
        IPointerExitHandler
    {
        public Action<bool> OnCardSelectionChanged;
        ...
        void Awake()
        {
            ...
            Canvas mainCanvas = GameObject.Find("MainCanvas").GetComponent<Canvas>(); // Suboptimal :c

            if (mainCanvas != null)
            {
                canvasRectTranform = mainCanvas.GetComponent<RectTransform>();
            }
        ...
        private void TransitionToState0()
        {
            ...
            OnCardSelectionChanged?.Invoke(false);
        }
        ...
        private void HandleHoverState()
        {
            ...
            OnCardSelectionChanged?.Invoke(true);
        }
